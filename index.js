let tod = new Date();
let nitishdd = tod.getDate();
let nitishmm = tod.getMonth() + 1; //January is 0 so need to add 1 to make it 1!
let nitishyy = tod.getFullYear();
if (nitishdd < 10) {
    nitishdd = '0' + nitishdd
}
if (nitishmm < 10) {
...
maxDate = nitishyy - 18 + '-' + nitishmm + '-' + nitishdd;
minDate = nitishyy - 55 + '-' + nitishmm + '-' + nitishdd;
